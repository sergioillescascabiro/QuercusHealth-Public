...
Output figures are committed to `reports/`. The executed notebooks (01, 02, 02b, 03) contain inline cell outputs.
...
notebooks/
  ...
  03_fine_tuning.ipynb                     # Phase 3: 2-class fine-tuning of DeepForest (executed)
  04_two_stage_pipeline.ipynb              # Phase 4: Detect all trees + ResNet-18 crop classifier
  05_end_to_end.ipynb                      # Phase 5: 1-class detector + classifier end-to-end
